...
<head>
  ...
  <title>memberInforUpdate.jsp</title>
...
<div class="container">
  ...
  <form name="myform" method="post" class="was-validated">
    ...
    <div class="form-group">
      <label for="mid">아이디 : ${vo.mid}</label>
    </div>
    <div class="form-group">
      <label for="pwd">비밀번호 : ${vo.pwd}</label>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="email1">Email address:</label>
        <div class="input-group mb-3">
          ...
          <input type="text" value="${email[0]}" class="form-control"  id="email1" name="email1" required />
   ...
   <div class="form-group">
    ...
    <button type="button" class="btn btn-outline-secondary" onclick="location.href='${ctp}/';">돌아가기</button>
