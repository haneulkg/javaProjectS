  	...
  	<table class="table table-bordered m-0">
  	  ...
  	  <tr>
  	    <td colspan="2" class="text-center">
  	      <input type="submit" value="로그인" class="btn btn-outline-secondary form-control mb-2" />
  	      <input type="reset" value="다시입력" class="btn btn-outline-secondary form-control mb-2" />
  	      <input type="button" value="회원가입" onclick="location.href='memberJoin';" class="btn btn-outline-secondary form-control" />
  	    </td>
  	  </tr>
  	 </table>
