...
<div class="container">
  ...
  <div>
		...
		ARIA가 사용하는 연산은 대부분 XOR과 같은 단순한 바이트단위연산으로, 블록크기는 128Bit(총 비트수:256Bit=64문자)이다.<br/>
  ...
  <div>
  	...
  	<input type="button" value="ARIA암호화" onclick="ariaCheck()" class="btn btn-outline-secondary" />
