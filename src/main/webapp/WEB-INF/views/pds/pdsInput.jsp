...
<jsp:include page="/WEB-INF/views/include/slide2.jsp" />
	...
	<div class="container">
		<form name="myform" method="post" enctype="multipart/form-data">
			<h2 class="text-center">자료 올리기</h2>
			<br/>
			<div>
				<!-- <input type="button" value="파일박스추가" onclick="fileBoxAppend()" class="btn btn-outline-info btn-sm mb-2"/> -->
			...
			<div>
				<input type="button" value="자료올리기" onclick="fCheck()" class="btn btn-outline-secondary form-control mb-2"/>
				<input type="reset" value="다시쓰기" class="btn btn-outline-secondary form-control mb-2"/>
				<input type="button" value="돌아가기" onclick="location.href='pdsList?part=${part}';" class="btn btn-outline-secondary form-control"/>
			</div>
