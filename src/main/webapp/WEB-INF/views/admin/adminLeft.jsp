...
<div class="text-center card-hover" id="accordion">
  ...
  <div class="vertical-menu">
    ...
    <div id="collapseTwo" class="collapse" data-parent="#accordion">	<!-- 처음부터 메뉴 보이게 하려면?  class="collapse show" -->
      ...
      <div class="m-0 p-0"><a href="${ctp}/dbShop/dbOption" target="adminContent">옵션등록관리</a></div>
      <div class="m-0 p-0"><a href="${ctp}/dbShop/adminOrderStatus" target="adminContent">주문관리</a></div>
    </div>
  </div>
  <hr/>
