			...
			<table class="table table-bordered">
				...
				<tr>
					<td colspan="2" class="text-center">
						<input type="submit" value="글올리기" class="btn btn-outline-secondary form-control"/> &nbsp; 
						<input type="reset" value="다시입력" class="btn btn-outline-secondary form-control"/> &nbsp; 
						<input type="button" onclick="location.href='boardList';" value="돌아가기" class="btn btn-outline-secondary form-control"/> &nbsp; 
					</td>
				</tr>
			</table>
